...
void block_free(const struct block_id b) {
...
int main() {
    ...
    printf("\n");
    const struct block_id bid1 = block_allocate(&global_heap);
    const struct block_id bid2 = block_allocate(&global_heap);
    const struct block_id bid3 = block_allocate(&global_heap);
    const struct block_id bid4 = block_allocate(&global_heap);
