...
public class UpdateId extends Command {
    ...
    public void execute(ArrayList<String> args) throws CommandExecutingException {
        if (args.size() != argAmount) {
            ...
            idToFind = Integer.parseInt(args.get(0));
            for (int i = 0; i < collection.size(); i++) {
                ...
                if (idToFind == collection.get(i).getId()) {
                    ...
                    curMovie.setCoordinates(new Coordinates(x, y));

                    // creationDate
                    LocalDateTime creationDate = LocalDateTime.now();
                    curMovie.setCreationDate(creationDate);
                    ...
                    curMovie.setOscarsCount(oscarsCount);
                    ...
                    curMovie.setTotalBoxOffice(totalBoxOffice);
                    ...
                    curMovie.setUsaBoxOffice(usaBoxOffice);
...
//            float weight_;
                    ...
                    curMovie.setOperator(new Person(operatorName, birthdate, weight, eyeColor, nationality));
                    return;
                }
            }
        }
